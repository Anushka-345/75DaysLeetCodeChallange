<h2><a href="https://leetcode.com/problems/minimum-edge-reversals-so-every-node-is-reachable/?envType=problem-list-v2&envId=interview-instance-ix">3105. Minimum Edge Reversals So Every Node Is Reachable</a></h2><h3>Hard</h3><hr><p>There is a <strong>simple directed graph</strong> with <code>n</code> nodes labeled from <code>0</code> to <code>n - 1</code>. The graph would form a <strong>tree</strong> if its edges were bi-directional.</p>
